...
class AppTheme {
  ...
  static const Color tealMid    = Color(0xFFB3EFE2);
  ...
  static ThemeData get light => ThemeData(
    ...
    textTheme: GoogleFonts.plusJakartaSansTextTheme().copyWith(
      displayLarge: GoogleFonts.instrumentSerif(
        fontSize: 36, fontStyle: FontStyle.italic, color: ink,
      ),
      displayMedium: GoogleFonts.instrumentSerif(
        fontSize: 28, fontStyle: FontStyle.italic, color: ink,
      ),
      displaySmall: GoogleFonts.instrumentSerif(
        fontSize: 22, fontStyle: FontStyle.italic, color: ink,
      ),
      ...
      bodyMedium: GoogleFonts.plusJakartaSans(
        fontSize: 13, fontWeight: FontWeight.w400, color: ink2,
      ),
      ...
      labelLarge: GoogleFonts.plusJakartaSans(
        ...
        letterSpacing: 0.06, color: muted,
      ),
    ),
