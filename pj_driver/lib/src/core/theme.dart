...
class AppTheme {
  // ── Colors ── (Driver uses orange accent)
  ...
  static ThemeData get light => ThemeData(
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      backgroundColor: card, selectedItemColor: orange, unselectedItemColor: muted,
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(style: OutlinedButton.styleFrom(
      foregroundColor: ink, minimumSize: const Size(double.infinity, 52),
