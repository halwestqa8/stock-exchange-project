...
class AppTheme {
  // ── Colors ── (Staff uses indigo accent for web dashboard)
  ...
  static ThemeData get light => ThemeData(
    ...
    primaryColor: indigo,
    colorScheme: ColorScheme.light(primary: indigo, secondary: ink, surface: card, error: red),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: indigo, width: 1.5)),
    ),
